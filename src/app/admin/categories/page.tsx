                        ...
                        <tr key={category?.id} className="border border-gray-200">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex gap-2 items-center">
                              <button
                                disabled={!canModify}
                                onClick={() => setShowEditCategory(category ?? undefined)}
                              ...
                              <button
                                disabled={!canModify}
                                onClick={() => setConfirmDelete(category ?? undefined)}
                                className={classNames(
                                  "text-red-500",
