...
import { FileInput, File as FileObj, TagInput, useUpdateTagMutation, useUsersQuery } from "@/graphql/__generated__/schema";
...
import { FormValues, IEditTagFormProps } from "./EditTargForm.types";



const EditTagForm = (props: IEditTagFormProps): JSX.Element => {
  ...
  const { register, handleSubmit, formState: { errors }, reset } = useForm<FormValues>({
    defaultValues: {
      displayName: props.tag.displayName ?? "",
