...
import { File as FileObj, Message, User } from "@/graphql/__generated__/schema";
...
const MessageCard: React.FC<{
  ...
  return (
    <>
      ...
      >
        {/* @ts-ignore */}
        <Avatar user={viewer} role={message.role ?? undefined} />
        <div
        ...
        >
          ...
          <div className={"text-[12px] flex items-center gap-2"}>
            <p>{format(fromUnixTime(message.createdAt ?? 0), DATE_TIME_FORMAT)}</p>
