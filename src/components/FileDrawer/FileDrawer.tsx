...
import { IFileDrawerProps } from "./FileDrawer.types";

const FileDrawer = (props: IFileDrawerProps): JSX.Element => {
  return (
    <div id={"left-drawer"}
      className={
      ...
      <div className={"p-4 h-screen flex flex-col gap-2"}>
        ...
        <div className={"overflow-y-auto flex-1"}>
          {props.file.content
            ? <div className={"whitespace-pre-line"}>{props.file.content}</div>
            : <div>
              {props.file.contentType === "text/plain"
                ? <FileContent id={props.file.id ?? ""} />
                : <div>
